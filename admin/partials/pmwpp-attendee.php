<article class="attendee pm-list-item" data-entity="<?php echo $item->id; ?>">
    ...
    <main>
        ...
        <div class="info">
            ...
            <div class="main-data">
                <div class="fullname">
                    <span class="name"><?php echo $item->name; ?></span>&nbsp;<span class="lastname"><?php echo $item->lastname; ?></span>
                </div>
                <div class="jobtitle">
                    <?php echo $item->job_title; ?>
                </div>
                <div class="company">
                    <?php echo $item->company->name; ?>
                </div>
            </div>
        ...
        <div class="details closed">
            ...
            <div class="company-website">
                <a href="<?php echo $item->company->website; ?>" target="_blank"><?php echo $item->company->website; ?></a>
            </div>
            <div class="country">
